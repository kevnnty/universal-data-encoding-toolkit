...
javase_jar = "../../jar-files/javase-3.5.0.jar"
core_jar = "../../jar-files/core-3.5.0.jar"
jcommander_jar = "../../jar-files/jcommander-1.82.jar"

barcode_image = "../../assets/given-image-01.jpg"
